...
RSpec.describe ProductImagesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested product_image as @product_image" do
      product_image = ProductImage.create! valid_attributes
      get :show, params: {id: product_image.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested product_image as @product_image" do
      product_image = ProductImage.create! valid_attributes
      get :edit, params: {id: product_image.to_param}, session: valid_session
      expect(assigns(:product_image)).to eq(product_image)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ProductImage" do
        expect {
          post :create, params: {product_image: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved product_image as @product_image" do
        post :create, params: {product_image: invalid_attributes}, session: valid_session
        expect(assigns(:product_image)).to be_a_new(ProductImage)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, params: {id: product_image.to_param, product_image: new_attributes}, session: valid_session
      ...
      it "assigns the requested product_image as @product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, params: {id: product_image.to_param, product_image: valid_attributes}, session: valid_session
        expect(assigns(:product_image)).to eq(product_image)
      end
    ...
    context "with invalid params" do
      it "assigns the product_image as @product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, params: {id: product_image.to_param, product_image: invalid_attributes}, session: valid_session
        expect(assigns(:product_image)).to eq(product_image)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested product_image" do
      product_image = ProductImage.create! valid_attributes
      expect {
        delete :destroy, params: {id: product_image.to_param}, session: valid_session
      }.to change(ProductImage, :count).by(-1)
    end
